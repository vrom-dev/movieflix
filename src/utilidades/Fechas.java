...
public class Fechas {
	 ...
	 * @para formato: formato de fecha que tendrá que introducir el usuario (ej: "dd/MM/yyyy", "dd-MM-yyyy", "yyyy-MM-dd").
	 */
	...
	/**
	 * Recibe un Objeto tipo LocalDate y lo convierte a String, siguiendo el formato especificado.
	 * @param fecha: objeto LocalDate que queremos convertir a String.
	 * @para formato: formato de fecha que tendrá que seguirá la conversión (ej: "dd/MM/yyyy", "dd-MM-yyyy", "yyyy-MM-dd").
	 */
